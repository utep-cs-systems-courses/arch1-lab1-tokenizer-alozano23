...
static char *test_find_word_terminator() {
  ...
  char *result = word_terminator(str);
...
static char *all_tests() {
 ...
 int main(int argc, char **argv) {   
   fputs("Hello, how are you? Please input a string following the '>' symbol on the next line\n>", stdout);
   char str[100];
   scanf("%s", str);
